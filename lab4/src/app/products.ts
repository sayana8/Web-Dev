...
export const products = [
  ...
  {
    id: 8,
    name: 'Smart speaker Yandex Station Light purple',
    price: 2999,
  ...
  {
    id: 9,
    name: 'Sneakers Nike Air Jordan Luka 2 ',
    price: 499,
    description: 'for my basketball career',
    ...
    img3 : "https://resources.cdn-kaspi.kz/img/m/p/h12/h31/84180585578526.jpg?format=gallery-medium",
